...
export const metadata = { title: "New Club — Settl Admin" };
  ...
  return (
    <div className="p-8 max-w-xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-foreground mt-4">New club</h1>
        <p className="text-sm text-muted mt-1">Creates a unique join link and PIN for this club or institution.</p>
      </div>

...
export default function NotificationsBell() {
  ...
  return (
    <a
      ...
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${pathname === "/club/notifications" ? "bg-brand-50 text-brand-700 shadow-sm border border-brand-100" : "text-muted hover:bg-surface hover:text-foreground"}`}
    >

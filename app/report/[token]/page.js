      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        {document ? (
          <DocumentView content={{
            ...
            university_notes: document.content?.university_notes || request.clubs?.custom_notes || null,
            university_links: document.content?.university_links || request.clubs?.custom_links || null,

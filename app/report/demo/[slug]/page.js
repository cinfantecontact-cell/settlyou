        ...
        <div className="max-w-4xl mx-auto px-4 pt-10 pb-8">
          <div className="flex items-center gap-3 mb-6">
            {client.logoUrl ? (
              ...
              <div
                className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 bg-white/20"
              >
          ...
          <h1 className="text-3xl font-bold text-white mb-2 leading-tight">
            {client.name}
            <br />
            <span className="text-white opacity-70">Sample Student Guide</span>
          </h1>
          <p className="text-white opacity-60 text-sm max-w-xl leading-relaxed">
            Every incoming student gets a personalized guide — built around who they are, where they're from, and what they need to land confidently in {client.city || "their new city"}.
          </p>
        </div>
      </div>

      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
        ...
        <tr>
          <td style="background:#1a1a1a;padding:32px 40px;text-align:center;">
            <img src="${process.env.NEXT_PUBLIC_APP_URL}/settlyou-logo.png" alt="Settl" height="32" style="display:block;margin:0 auto;">
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td style="padding:40px;">
            ...
            <div style="text-align:center;margin:32px 0;">
              <a href="${reportUrl}" style="display:inline-block;background:#111;color:#fff;font-size:16px;font-weight:600;padding:16px 36px;border-radius:8px;text-decoration:none;">
...
export async function sendAdminNewSubmission({ athleteName, clubName, destinationCity, destinationCountry }) {
  await resend.emails.send({
    from: "Settl Notifications <onboarding@resend.dev>",
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="background:#1a1a1a;padding:24px 40px;">
            <img src="${process.env.NEXT_PUBLIC_APP_URL}/settlyou-logo.png" alt="Settl" height="28" style="display:block;">
          </td>
        </tr>
        <tr>

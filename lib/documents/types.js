export const BASE_DOCUMENT_TYPES = [
  ...
  { key: "transcript_translation", label: "Transcript Translation (if not in English)", required: true },
  { key: "english_test", label: "English Proficiency Test (TOEFL / IELTS / Duolingo)", required: true },
  { key: "eligibility_form", label: "NAIA / NCAA Eligibility Form", required: true },
  { key: "insurance", label: "Health Insurance Card", required: true },
  { key: "photo", label: "Headshot Photo", required: true },
];

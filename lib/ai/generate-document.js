...
export async function generateBaseData(club) {
  ...
  console.log(`[generate-base] generating base data for ${club.name} (${club.type}) with web search...`);
  // Use Sonnet with web search for rich, accurate city data
  return await callModel("claude-sonnet-4-6", 24000, prompt, true);
}
